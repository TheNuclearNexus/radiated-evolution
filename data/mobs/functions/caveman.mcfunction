...
#Walking anim
execute if entity  @s[tag=!RE_moving] at @s if score @s RE_MotionX matches 0 if score @s RE_MotionZ matches 0 if score timer_10 du_data matches 9 run data merge entity @s[tag=RE_cavestand,sort=nearest,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:stone_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:53}}]}
execute if entity  @s[tag=RE_moving] at @s if score timer_10 du_data matches 0 run data merge entity @s[tag=RE_cavestand,sort=nearest,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:stone_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:54}}]}
execute if entity  @s[tag=RE_moving] at @s if score timer_10 du_data matches 5 run data merge entity @s[tag=RE_cavestand,sort=nearest,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:stone_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:55}}]}

#Effects for zombie
effect give @s minecraft:invisibility 1 1 true

#Stand tp
tp @s[tag=RE_cavestand,sort=nearest,distance=..1,limit=1] @s
...
execute if entity  @s[type=villager,tag=RE_hit] at @s store result entity @s[tag=RE_caveman,type=zombie,sort=nearest,limit=1] Health float 1 run data get entity @s Health
execute if entity  @s[type=villager,tag=RE_hit] at @s store result entity @s[tag=RE_caveman,type=zombie,sort=nearest,limit=1] Fire double 1 run data get entity @s Fire
